...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div3, "click", /*handleOuterClick*/ ctx[17], false, false, false)
    				];
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div1_transition) div1_transition = create_bidirectional_transition(div1, /*currentTransitionWindow*/ ctx[14], /*state*/ ctx[0].transitionWindowProps, true);
    				div1_transition.run(1);
    			});

    			add_render_callback(() => {
    				if (!div3_transition) div3_transition = create_bidirectional_transition(div3, /*currentTransitionBg*/ ctx[13], /*state*/ ctx[0].transitionBgProps, true);
    		...
    		o: function outro(local) {
    			...
    			if (!div1_transition) div1_transition = create_bidirectional_transition(div1, /*currentTransitionWindow*/ ctx[14], /*state*/ ctx[0].transitionWindowProps, false);
    			div1_transition.run(0);
    			if (!div3_transition) div3_transition = create_bidirectional_transition(div3, /*currentTransitionBg*/ ctx[13], /*state*/ ctx[0].transitionBgProps, false);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 250, 10, 5885);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*close*/ ctx[15], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(250:8) {#if state.closeButton}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("closeButton" in $$props) $$invalidate(19, closeButton = $$props.closeButton);
    		if ("closeOnEsc" in $$props) $$invalidate(20, closeOnEsc = $$props.closeOnEsc);
    		if ("closeOnOuterClick" in $$props) $$invalidate(21, closeOnOuterClick = $$props.closeOnOuterClick);
    		if ("styleBg" in $$props) $$invalidate(22, styleBg = $$props.styleBg);
    		if ("styleWindow" in $$props) $$invalidate(23, styleWindow = $$props.styleWindow);
    		if ("styleContent" in $$props) $$invalidate(24, styleContent = $$props.styleContent);
    		if ("setContext" in $$props) $$invalidate(25, setContext$1 = $$props.setContext);
    		if ("transitionBg" in $$props) $$invalidate(26, transitionBg = $$props.transitionBg);
    		if ("transitionBgProps" in $$props) $$invalidate(27, transitionBgProps = $$props.transitionBgProps);
    		if ("transitionWindow" in $$props) $$invalidate(28, transitionWindow = $$props.transitionWindow);
    		if ("transitionWindowProps" in $$props) $$invalidate(29, transitionWindowProps = $$props.transitionWindowProps);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentTransitionBg" in $$props) $$invalidate(13, currentTransitionBg = $$props.currentTransitionBg);
    		if ("currentTransitionWindow" in $$props) $$invalidate(14, currentTransitionWindow = $$props.currentTransitionWindow);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*state*/ 1) {
    			 $$invalidate(13, currentTransitionBg = state.transitionBg);
    		}

    		if ($$self.$$.dirty[0] & /*state*/ 1) {
    			 $$invalidate(14, currentTransitionWindow = state.transitionWindow);
    		}
    	};
    	...
    	constructor(options) {
    		...
    		init(
    			...
    			safe_not_equal,
    			{
    				...
    				closeButton: 19,
    				closeOnEsc: 20,
    				closeOnOuterClick: 21,
    				styleBg: 22,
    				styleWindow: 23,
    				styleContent: 24,
    				setContext: 25,
    				transitionBg: 26,
    				transitionBgProps: 27,
    				transitionWindow: 28,
    				transitionWindowProps: 29
    			},
    			[-1, -1]
    		);
    ...
    /* src\components\Help.svelte generated by Svelte v3.24.0 */

    const file$1 = "src\\components\\Help.svelte";
    ...
    class Help extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*message*/ ctx[0] === undefined && !("message" in props)) {
    			console.warn("<Help> was created without expected prop 'message'");
    		}
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			a0 = element("a");
    			a0.textContent = "JOIN ROOM";
    			t1 = space();
    			a1 = element("a");
    			a1.textContent = "CREATE ROOM";
    			t3 = space();
    			button = element("button");
    			button.textContent = "❔❓ How to play";
    			attr_dev(a0, "href", "/join");
    			attr_dev(a0, "class", "btn btn-success my-2");
    			add_location(a0, file$2, 14, 2, 733);
    			attr_dev(a1, "href", "/create");
    			attr_dev(a1, "class", "btn btn-primary my-2");
    			add_location(a1, file$2, 15, 2, 804);
    			attr_dev(button, "class", "btn my-2");
    			add_location(button, file$2, 16, 2, 879);
    			attr_dev(main, "class", "svelte-tctnrp");
    			add_location(main, file$2, 13, 0, 723);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*showHelp*/ ctx[0], false, false, false)
    				];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const showHelp = () => {
    		open(Help, {
    			message: "Among the room, there are spies who don't know what the actual answer is. Each player takes turn to describe the answer including the spies. The spies have to guess what the answer is by analyzing how other describe it. After each round, the spies can come out and say the actual answer and win if they are confident, players can vote one person as spy and kick the person out. Players win by finding out all the spies, spies win by successfully guess what the answer is."
    		});
    	};
    	...
    	$$self.$capture_state = () => ({ link, getContext, Help, open, showHelp });
    	return [showHelp];
    }
    ...
    /* src\components\JoinRoom.svelte generated by Svelte v3.24.0 */

    const { console: console_1$1 } = globals;
    const file$3 = "src\\components\\JoinRoom.svelte";

    // (24:2) {#if warningMessage}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*warningMessage*/ ctx[1]);
    			attr_dev(p, "class", "alert alert-danger");
    			add_location(p, file$3, 24, 4, 764);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*warningMessage*/ 2) set_data_dev(t, /*warningMessage*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*warningMessage*/ ctx[1] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			if (if_block) if_block.c();
    			attr_dev(h2, "class", "bg-dark");
    			add_location(h2, file$3, 17, 2, 442);
    			attr_dev(div0, "class", "my-2");
    			add_location(div0, file$3, 18, 2, 480);
    			attr_dev(p, "class", "bg-dark");
    			add_location(p, file$3, 19, 2, 508);
    			set_style(input, "text-transform", "uppercase");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "maxlength", "4");
    			attr_dev(input, "class", "svelte-1ubo5b6");
    			add_location(input, file$3, 20, 2, 545);
    			attr_dev(div1, "class", "my-2");
    			add_location(div1, file$3, 21, 2, 637);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$3, 22, 2, 665);
    			attr_dev(main, "class", "svelte-1ubo5b6");
    			add_location(main, file$3, 16, 0, 432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*startRoom*/ ctx[2], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	const startRoom = () => {
    		if (roomCode === undefined || roomCode.length !== 4) {
    			$$invalidate(1, warningMessage = "You must enter a code with 4 characters.");
    		} else {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<JoinRoom> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("JoinRoom", $$slots, []);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("warningMessage" in $$props) $$invalidate(1, warningMessage = $$props.warningMessage);
    	};
    	...
    	return [roomCode, warningMessage, startRoom, input_input_handler];
    }

    class JoinRoom extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_else_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input_1, file$9, 805, 4, 19861);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_attributes(input_1, input_1_data);
    			toggle_class(input_1, "svelte-2eeumy", true);
    			add_location(input_1, file$9, 796, 4, 19649);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input_1, anchor);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 815, 4, 20094);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$9, 831, 8, 20557);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "-2 -2 50 50");
    			attr_dev(svg, "focusable", "false");
    			...
    			add_location(svg, file$9, 825, 6, 20416);
    			attr_dev(div, "class", "clearSelect svelte-2eeumy");
    			add_location(div, file$9, 824, 4, 20346);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_if_block_1$2(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*indicatorSvg*/ ctx[20]) return create_if_block_2$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 840, 4, 20991);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if_block.m(div, null);
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$9, 849, 10, 21212);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "0 0 20 20");
    			attr_dev(svg, "focusable", "false");
    			attr_dev(svg, "class", "svelte-2eeumy");
    			add_location(svg, file$9, 844, 8, 21091);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$9, 863, 8, 21717);
    			attr_dev(svg, "class", "spinner_icon svelte-2eeumy");
    			attr_dev(svg, "viewBox", "25 25 50 50");
    			add_location(svg, file$9, 862, 6, 21660);
    			attr_dev(div, "class", "spinner svelte-2eeumy");
    			add_location(div, file$9, 861, 4, 21632);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_fragment$a(ctx) {
    	...
    	let if_block5 = (/*showIndicator*/ ctx[18] || (/*showChevron*/ ctx[17] && !/*selectedValue*/ ctx[3] || !/*isSearchable*/ ctx[13] && !/*isDisabled*/ ctx[9] && !/*isWaiting*/ ctx[5] && (/*showSelectedItem*/ ctx[24] && !/*isClearable*/ ctx[15] || !/*showSelectedItem*/ ctx[24]))) && create_if_block_1$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 770, 0, 19041);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\CreateRoom.svelte generated by Svelte v3.24.0 */

    const { console: console_1$2 } = globals;
    const file$a = "src\\components\\CreateRoom.svelte";

    // (49:2) {#if warningMessage}
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*warningMessage*/ ctx[5]);
    			attr_dev(p, "class", "alert alert-danger");
    			add_location(p, file$a, 49, 4, 1809);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*warningMessage*/ 32) set_data_dev(t, /*warningMessage*/ ctx[5]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_fragment$b(ctx) {
    	...
    	if (/*selectedCategory*/ ctx[3] !== void 0) {
    		select0_props.selectedValue = /*selectedCategory*/ ctx[3];
    	}
    	...
    	let select1_props = {
    		items: /*numOfPlayers*/ ctx[2],
    		isSearchable: false,
    		isClearable: false
    	};

    	if (/*selectedNumOfPlayers*/ ctx[4] !== void 0) {
    		select1_props.selectedValue = /*selectedNumOfPlayers*/ ctx[4];
    	}
    	...
    	let if_block = /*warningMessage*/ ctx[5] && create_if_block$6(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h2 = element("h2");
    			h2.textContent = "CREATE ROOM";
    			t1 = space();
    			h4 = element("h4");
    			t2 = text("Room Code: ");
    			t3 = text(/*roomCode*/ ctx[0]);
    			t4 = space();
    			div0 = element("div");
    			t5 = space();
    			p0 = element("p");
    			p0.textContent = "Choose Category:";
    			t7 = space();
    			...
    			t9 = space();
    			p1 = element("p");
    			p1.textContent = "🕵️‍♂️🕵️‍♀️ Number of Players (4-15, 5 or less 1 spy, 6 to 10 2 spies, 11 or more 3 spies):";
    			t11 = space();
    			...
    			if (if_block) if_block.c();
    			attr_dev(h2, "class", "bg-dark");
    			add_location(h2, file$a, 38, 2, 1130);
    			attr_dev(h4, "class", "bg-dark");
    			add_location(h4, file$a, 39, 2, 1170);
    			attr_dev(div0, "class", "my-2");
    			add_location(div0, file$a, 40, 2, 1220);
    			attr_dev(p0, "class", "bg-dark");
    			add_location(p0, file$a, 41, 2, 1248);
    			attr_dev(div1, "class", "my-2");
    			add_location(div1, file$a, 43, 2, 1410);
    			attr_dev(p1, "class", "bg-dark");
    			add_location(p1, file$a, 44, 2, 1438);
    			attr_dev(div2, "class", "my-2");
    			add_location(div2, file$a, 46, 2, 1682);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$a, 47, 2, 1710);
    			attr_dev(main, "class", "svelte-tctnrp");
    			add_location(main, file$a, 37, 0, 1120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, p0);
    			append_dev(main, t7);
    			mount_component(select0, main, null);
    			append_dev(main, t8);
    			append_dev(main, div1);
    			append_dev(main, t9);
    			append_dev(main, p1);
    			append_dev(main, t11);
    			mount_component(select1, main, null);
    			append_dev(main, t12);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*startRoom*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*roomCode*/ 1) set_data_dev(t3, /*roomCode*/ ctx[0]);
    			const select0_changes = {};
    			if (dirty & /*categories*/ 2) select0_changes.items = /*categories*/ ctx[1];

    			if (!updating_selectedValue && dirty & /*selectedCategory*/ 8) {
    				updating_selectedValue = true;
    				select0_changes.selectedValue = /*selectedCategory*/ ctx[3];
    				add_flush_callback(() => updating_selectedValue = false);
    			}

    			select0.$set(select0_changes);
    			const select1_changes = {};
    			if (dirty & /*numOfPlayers*/ 4) select1_changes.items = /*numOfPlayers*/ ctx[2];

    			if (!updating_selectedValue_1 && dirty & /*selectedNumOfPlayers*/ 16) {
    				updating_selectedValue_1 = true;
    				select1_changes.selectedValue = /*selectedNumOfPlayers*/ ctx[4];
    				add_flush_callback(() => updating_selectedValue_1 = false);
    			}

    			select1.$set(select1_changes);

    			if (/*warningMessage*/ ctx[5]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	const startRoom = () => {
    		if (selectedCategory === undefined || selectedNumOfPlayers === undefined) {
    			$$invalidate(5, warningMessage = "You must select a category and number of players");
    		} else {
    			console.log(`Selected ${selectedCategory.value} with ${selectedNumOfPlayers.value} players`);

    			fetch(`/api/startRoom/${roomCode}/${selectedCategory.value}/${selectedNumOfPlayers.value}`).then(response => response.json()).then(data => {
    	...
    	fetch("/api/createRoom").then(response => response.json()).then(data => {
    		$$invalidate(0, roomCode = data.code);
    		$$invalidate(1, categories = data.categories);
    		$$invalidate(2, numOfPlayers = data.numOfPlayers);
    	});

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<CreateRoom> was created with unknown prop '${key}'`);
    	});
    	...
    	function select1_selectedValue_binding(value) {
    		selectedNumOfPlayers = value;
    		$$invalidate(4, selectedNumOfPlayers);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("numOfPlayers" in $$props) $$invalidate(2, numOfPlayers = $$props.numOfPlayers);
    		if ("selectedCategory" in $$props) $$invalidate(3, selectedCategory = $$props.selectedCategory);
    		if ("selectedNumOfPlayers" in $$props) $$invalidate(4, selectedNumOfPlayers = $$props.selectedNumOfPlayers);
    ...
    /* src\components\Room.svelte generated by Svelte v3.24.0 */
    const file$b = "src\\components\\Room.svelte";
    ...
    function create_else_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "bg-dark large");
    			add_location(p, file$b, 30, 4, 688);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*answer*/ ctx[1]);
    			attr_dev(p, "class", "bg-dark large");
    			add_location(p, file$b, 28, 4, 634);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$c(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*answer*/ ctx[1]) return create_if_block$7;
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h4 = element("h4");
    			h4.textContent = `Room Code: ${/*roomCode*/ ctx[2]}`;
    			t2 = space();
    			div0 = element("div");
    			t3 = space();
    			p0 = element("p");
    			...
    			attr_dev(h4, "class", "bg-dark");
    			add_location(h4, file$b, 21, 2, 403);
    			attr_dev(div0, "class", "my-2");
    			add_location(div0, file$b, 22, 2, 453);
    			attr_dev(p0, "class", "bg-dark");
    			add_location(p0, file$b, 23, 2, 481);
    			attr_dev(p1, "class", "bg-dark");
    			add_location(p1, file$b, 24, 2, 517);
    			attr_dev(div1, "class", "my-2");
    			add_location(div1, file$b, 25, 2, 554);
    			attr_dev(p2, "class", "bg-dark");
    			add_location(p2, file$b, 26, 2, 582);
    			attr_dev(div2, "class", "my-2");
    			add_location(div2, file$b, 32, 2, 746);
    			attr_dev(button, "class", "btn btn-danger");
    			add_location(button, file$b, 33, 2, 774);
    			attr_dev(main, "class", "svelte-tctnrp");
    			add_location(main, file$b, 20, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*restart*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*category*/ 1) set_data_dev(t6, /*category*/ ctx[0]);
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	fetch(`/api/enterRoom/${roomCode}`).then(response => response.json()).then(data => {
    		$$invalidate(0, category = data.category);
    		$$invalidate(1, answer = data.answer);
    	});
    	...
    	return [category, answer, roomCode, restart, params];
    }
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a0 = element("a");
    			h1 = element("h1");
    			h1.textContent = "Who is The Spy?";
    			t1 = space();
    			create_component(modal.$$.fragment);
    			t2 = space();
    			a1 = element("a");
    			a1.textContent = "@seancrx";
    			attr_dev(h1, "class", "svelte-1kk7c4u");
    			add_location(h1, file$c, 19, 13, 455);
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$c, 19, 1, 443);
    			attr_dev(a1, "href", "https://github.com/seancrx");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "credits svelte-1kk7c4u");
    			add_location(a1, file$c, 23, 1, 525);
    			attr_dev(main, "class", "svelte-1kk7c4u");
    			add_location(main, file$c, 18, 0, 435);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
